...
class ProfileAll extends LitElement {
  ...
  getUserData() {
    ...
    this.userData = {
      avatar: getImageURL(data.collectionId, data.id, data.avatar),
  ...
  render() {
    return html`
      <div class="profile-all">
        <div class="profile-all-wrap">
          ...
          >
            <img
              ...
              alt="${this.userData.userName}의 프로필 사진"
            />
        ...
        <profile-popup
          @popup-changed=${(e: CustomEvent) =>
            this.updateAriaExpanded(e, ".profile-edit-button")}
        ></profile-popup>
        ...
        <div class="profile-btn-wrap">
          ...
          <create-feed
            @popup-changed=${(e: CustomEvent) =>
              this.updateAriaExpanded(e, ".feed-button")}
          ></create-feed>
        </div>
      </div>
    `;
